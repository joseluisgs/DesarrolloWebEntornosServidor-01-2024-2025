...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        var d1 = storage.importTenistas(new File("data01.csv"))
                .subscribe(
                        repositorio::save,
        ...
        var d2 = storage.importTenistas(new File("data02.csv"))
                .subscribe(
                        repositorio::save,
                        error -> System.err.println("Error al importar los tenistas: " + error),
        ...
        var notificaciones = repositorio.getNotificaciones()
                .subscribe(lista -> System.out.println("Nueva actualización: " + lista));
        var listaActualizada = repositorio.getListaActualizada()
